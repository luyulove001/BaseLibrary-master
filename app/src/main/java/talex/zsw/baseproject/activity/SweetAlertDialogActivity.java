 ...
 * 作用: 简易Dialog的使用
 * 作者: XNN  
 * 日期: 2015 15/11/24 13:52 
 * 修改人：
 * 修改时间：
 * 修改备注：
 */
public class SweetAlertDialogActivity extends BaseAppCompatActivity implements View.OnClickListener
{
	private int i = -1;
				...
				new CountDownTimer(800 * 7, 800)
				{
					public void onTick(long millisUntilFinished)
					{
						...
						switch (i)
						{
							...
							case 3:
								pDialog.getProgressHelper().setBarColor(
									getResources().getColor(R.color.material_deep_teal_20));
								break;
							case 4:
								pDialog.getProgressHelper().setBarColor(
									getResources().getColor(R.color.material_blue_grey_80));
								break;
							case 5:
								pDialog.getProgressHelper().setBarColor(
